...
Version  : 1.16.1
Release  : 34
URL      : https://cran.r-project.org/src/contrib/network_1.16.1.tar.gz
Source0  : https://cran.r-project.org/src/contrib/network_1.16.1.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1602176224
