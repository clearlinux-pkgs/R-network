...
Version  : 1.19.0
Release  : 62
URL      : https://ftp.osuosl.org/pub/cran/src/contrib/network_1.19.0.tar.gz
Source0  : https://ftp.osuosl.org/pub/cran/src/contrib/network_1.19.0.tar.gz
...
%package dev
Summary: dev components for the R-network package.
Group: Development
Requires: R-network-lib = %{version}-%{release}
Provides: R-network-devel = %{version}-%{release}
Requires: R-network = %{version}-%{release}

%description dev
dev components for the R-network package.
...
%setup -q -n network
pushd ..
cp -a network buildavx2
popd
pushd ..
cp -a network buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1733821443
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/R/library/network/libs/network.so
/V4/usr/lib64/R/library/network/libs/network.so
